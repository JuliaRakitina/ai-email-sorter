...
def list_message_ids(gmail_service, user_id: str, q: str, max_results: int = 25) -> List[str]:
    resp = gmail_service.users().messages().list(userId=user_id, q=q, maxResults=max_results).execute()
